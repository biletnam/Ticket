...
<body>
  ...
  <form action="theater-owner-login-submit" method="post" id="loginSubmitId">
  <s:hidden name = "loginBean.role_xid" value="1"/>
  	
    <section class="function1" >
       <div class="container-fluid login-body theatre-owner-bg"  >
       						
         <div class="row " >
          <div class="col-md-4">
         </div>
          <div class="col-md-4 login-margintop" >
         <h4 class="text-center fx-white"><b>THEATRE OWNER LOGIN</b></h4> 
        ...
        <p class="fx-white"><input id="rememberMe" type="checkbox" class="checkbox"><b> Remember Me</b>
             <span><a href="forget-password" class="forgot pull-right" > Forgot Password ? </a> </span></p>
            <button id="loginFormId" type="submit" class="btn btn-primary btn-block fx-primary-button" style="">Login to proceed</button>
            <p class="m-t-sm font-weight-bold  text-white"> <a href="theatre-owner-registration" > Create New Account </a> </p>
            </div>
          </div>
        </div>
     </section>
