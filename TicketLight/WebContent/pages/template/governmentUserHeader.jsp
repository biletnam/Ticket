        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header" style="padding-top: 11px;">
                 ...
                 <img alt="image" style="width: 42%;height: 71px;" class="img-circle"  src="img/Profile.png" />
                             </span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><s:property value="%{#session.name}"/></strong>
                             </span> <span class="text-muted text-xs block">Government User<b class="caret"></b></span> </span> </a>
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <!--  <li><a href="theater-counter-profile-view">Profile</a></li>
                            <li><a href="change-password">Change password</a></li>
                            <li class="divider"></li> -->
                            <li><a href="government-user-logout">Logout</a></li>
                        </ul>
	               ...
	               <li class="dashboardCls">
		               <a href="government-user-login-success"><i class="fa fa-ticket" aria-hidden="true"></i>
					 <span class="nav-label">Dashboard</span></a>
	               </li>
	                <li class="taxDetailCls">
		               <a href="tax-detail"><i class="fa fa-ticket" aria-hidden="true"></i>
					 <span class="nav-label">Tax Detail</span></a>
	               </li>
        </div>
    </nav>
</div>
