...
<body>
  ...
  <form action="government-user-login-submit" method="post" id="loginSubmitId">
  <s:hidden name = "loginBean.role_xid" value="3"/>
  	
    <section class="function1" >
       <div class="container-fluid login-body government-bg"  >
       <div class="row " >
          <div class="col-md-4">
         </div>
          <div class="col-md-4 login-margintop" >
         <h4 class="text-center fx-white"><b>GOVERNMENT LOGIN</b></h4>  
        ...
        <p class="fx-white"><input id="rememberMe" type="checkbox" class="checkbox"><b> Remember Me</b>
             <span><a href="government-forget-password" class="forgot pull-right" > Forgot Password ? </a> </span></p>
