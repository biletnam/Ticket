...
<div class="wrapper wrapper-content ">
         <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h2 class="font-bold">Add Screen  <span class="pull-right">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1"> <label>:</label></div>
                    <div class="col-sm-6">
                        <input type="text" class="form-control m-l txtNumeric validate[required]" id="passageCountId">
                    </div>
                </div>
                 <div class="form-group">
                    ...
                    <div class="col-sm-3">
                         <div class="form-group" id="data_5">
                                ...
                                <s:select list="theaterOwnerBean.ticketCategoryMap"  id="categoryFromId" cssClass = "form-control validate[required]" headerKey="" headerValue="--Select Category--"/>
                                    <span class="input-group-addon">to</span>
                                 <s:select list="theaterOwnerBean.ticketCategoryMap" id="categoryToId"  cssClass = "form-control validate[required]" headerKey="" headerValue="--Select Category--"/> 
                                </div>
                            </div>
                    </div>
