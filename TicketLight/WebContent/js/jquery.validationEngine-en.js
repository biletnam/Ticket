	...
	$.validationEngineLanguage = {
		newLang : function() {
			$.validationEngineLanguage.allRules = {
				...
				"max" : {
					"regex" : /^[\-\+]?\d{1,8}$/,
					"alertText" : "* Enter within 8 digits",
				},
				"past" : {
					"regex" : "none",
				...
				"passport" : {
					...
					// e-mail-state-%28type=email%29 )
					"regex" : /^[a-zA-Z0-9]{8}$/,
					"alertText" : "* 8 Digit Alpha Numeric"
				},
				"voteId" : {
					// HTML5 compatible email regex (
					// http://www.whatwg.org/specs/web-apps/current-work/multipage/states-of-the-type-attribute.html#
					// e-mail-state-%28type=email%29 )
					"regex" : /^[a-zA-Z0-9]{10}$/,
					"alertText" : "* 10 Digit Alpha Numeric"
				},
				"drivingLicense" : {
					// HTML5 compatible email regex (
					// http://www.whatwg.org/specs/web-apps/current-work/multipage/states-of-the-type-attribute.html#
				...
				"website" : {
					...
					"alertText" : "* Invalid url address"
				},
				"integer" : {
					"regex" : /^\d*(?:\.\d{1,2})?$/,
					"alertText" : "* Enter Only Integer"
				},
				"number" : {
				...
				"date" : {
					...
					"func" : function(field) {
						...
						var month = match[2] * 1;
						var day = match[3] * 1;
						var date = new Date(month - 1, day,year); // because
																	// months
																	// starts
																	// from 0.

						return (date.getMonth() == (month - 1) && date
								.getDate() == day && date.getFullYear() == year);
					},
				...
				"pwd" : {
					...
					"alertText" : "* password should contain one digit,one lower case,one upper case,One special character,<br>atleast 6 character  from the mentioned characters"
				},
				"validateExistName" : {
