...
public interface ITheaterOwnerManager {
...
//created by ramya 30-07-18
	...
	Map<Integer, String> getUserRoleMap()throws Exception;

	TheaterOwnerBean settTheaterAddUserSubmit(TheaterOwnerBean theaterOwnerBean)throws Exception;

	//TemplateBean getEmployeeInviteTemplate(TheaterOwnerBean theaterOwnerBean)throws Exception;
